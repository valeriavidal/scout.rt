...
constructor() {
  super();
  this.additionalDivMode = BeanColumn.AdditionalDivMode.AUTO;
}


static AdditionalDivMode = {
  NEVER: 0,
  AUTO: 1
};
...
buildCellForRow(row) {
  ...
  if (this.additionalDivMode === BeanColumn.AdditionalDivMode.AUTO && Device.get().tableAdditionalDivRequired) {
